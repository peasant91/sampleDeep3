...
const PickerScreen = ({ navigation, route }) => {
  ...
  const onPressReset = () => {
    navigation.navigate(route.params.previousRoute, { pickerId: pickerId, id: undefined, name: undefined, isEdit: isEdit, dispatch: dispatch, isRegister: isRegister }, true)
  }
  ...
  return (
    <SafeAreaView style={style.container}>
      ...
      {
        selectedId && (pickerId == 'driver_company_id' || pickerId == 'driver_partner_id') && <CustomButton
          types="primary"
          title='Hapus Pilihan'
