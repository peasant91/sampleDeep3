import {
    FlatList, KeyboardAvoidingView, RefreshControl, SafeAreaView, StyleSheet, View, ScrollView
} from 'react-native';
...
export const dummyContractShimmer = [dummyContractData, dummyContractData, dummyContractData, dummyContractData,];
    ...
    return (<SafeAreaView style={{backgroundColor: 'white', flex: 1}}>
        <KeyboardAvoidingView
            ...
            <View style={{flex: 1}}>
                ...
                {isNotRegisterVehicle ? (<ScrollView
                    refreshControl={<RefreshControl refreshing={isLoading} onRefresh={onRefresh}/>}
                    contentContainerStyle={{flex: 1}}>
                    <ErrorNotRegisterVehicle/>
                </ScrollView>) : isLoading ? (dummyContractShimmer.map((item, index) => {
