...
export const MainTitle = ({children, style = {}, numOfLines}) => {
  return (
    <Text
      style={[
        {fontFamily: 'Raleway-Bold', color: Colors.primaryText, fontSize: 18},
        style,
      ]}>
      {children}
    </Text>
...
export const RobotoRegular = ({children, style = {}, numOfLines}) => {
  return (
    <Text
      style={[
        {fontFamily: 'Roboto-Regular', color: Colors.primaryText, fontSize: 14},
        style,
      ]}>
      {children}
    </Text>
...
export const RobotoBold = ({children, style = {}, numOfLines}) => {
  return (
    <Text
      style={[
        {fontFamily: 'Roboto-Bold', color: Colors.primaryText, fontSize: 14},
        style,
      ]}>
      {children}
    </Text>
